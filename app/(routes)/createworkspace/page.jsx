...
import { Loader, Loader2Icon, SmilePlus } from 'lucide-react';
      ...
      <div className='shadow-2xl rounded-xl'>
        ...
        <CoverPicker setNewCover={(v)=>setCoverImage(v)}>
          <div className='relative group cursor-pointer'>
            ...
            <div className='group-hover:opacity-40'>
              <Image src={coverImage} alt="Workspace preview image" width={400} height={400}
        ...
        <div className='p-12'>
          ...
          <div className='mt-7 flex justify-end gap-6'>
            <Button disabled={!workspaceName?.length || loading} className="bg-blue-500 hover:bg-blue-700 text-white"
